...
# 39 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
Std_ReturnType lcd_8bit_intialize(const lcd_8bit_t *_lcd){
    ...
    if(((void*)0) == _lcd){
        ...
        status = lcd_8bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        status = lcd_8bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        status = lcd_8bit_send_command(_lcd, 0x38);
        status = lcd_8bit_send_command(_lcd, 0x01);
        status = lcd_8bit_send_command(_lcd, 0x02);
        status = lcd_8bit_send_command(_lcd, 0x06);
        status = lcd_8bit_send_command(_lcd, 0x0C);
        status = lcd_8bit_send_command(_lcd, 0x38);
        status = lcd_8bit_send_command(_lcd, 0x80);
    }
    return status;
}
...
Std_ReturnType lcd_8bit_send_custom_char(const lcd_8bit_t *_lcd, uint8 row, uint8 column, uint8 chr[], uint8 mem_pos){
    ...
    if(((void*)0) == _lcd){
        ...
        status = lcd_8bit_send_command(_lcd, 0x40 + (mem_pos*8));
...
Std_ReturnType lcd_4bit_intialize(const lcd_4bit_t *_lcd){
    ...
    if(((void*)0) == _lcd){
        ...
        _delay((unsigned long)((20)*(8000000/4000.0)));
        status = lcd_4bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        status = lcd_4bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        status = lcd_4bit_send_command(_lcd, 0x38);
        status = lcd_4bit_send_command(_lcd, 0x01);
        status = lcd_4bit_send_command(_lcd, 0x02);
        status = lcd_4bit_send_command(_lcd, 0x06);
        status = lcd_4bit_send_command(_lcd, 0x0C);
        status = lcd_4bit_send_command(_lcd, 0x28);
        status = lcd_4bit_send_command(_lcd, 0x80);
    }
    return status;
}
...
Std_ReturnType lcd_4bit_send_custom_char(const lcd_4bit_t *_lcd, uint8 row, uint8 column, uint8 chr[], uint8 mem_pos){
    ...
    if(((void*)0) == _lcd){
        ...
        status = lcd_4bit_send_command(_lcd, 0x40 + (mem_pos*8));
        for(l_counter = 0; l_counter<8; l_counter++){
...
static Std_ReturnType lcd_8bit_set_pos(const lcd_4bit_t *_lcd, uint8 row, uint8 column){
    ...
    column--;
    switch(row){
        case 1 : status = lcd_8bit_send_command(_lcd, (0x80 + column)); break;
        case 2 : status = lcd_8bit_send_command(_lcd, (0xC0 + column)); break;
        default : ;
    }
    return status;
}
...
static Std_ReturnType lcd_4bit_set_pos(const lcd_4bit_t *_lcd, uint8 row, uint8 column){
    ...
    column--;
    switch(row){
        case 1 : status = lcd_4bit_send_command(_lcd, (0x80 + column)); break;
        case 2 : status = lcd_4bit_send_command(_lcd, (0xC0 + column)); break;
        default : ;
    }
    return status;
}
