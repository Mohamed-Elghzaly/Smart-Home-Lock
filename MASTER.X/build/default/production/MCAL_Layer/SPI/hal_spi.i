...
# 39 "MCAL_Layer/SPI/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
Std_ReturnType SPI_Initialize(const MSSP_SPI_t *_spi){
    ...
    if(((void*)0) == _spi){
        ...
        if(1 == _spi->spi_clock_polarity){
            (SSPCON1bits.CKP = 1);
        }
        else if(0 == _spi->spi_clock_polarity){
            (SSPCON1bits.CKP = 0);
        }
        else{ }

        if(0 == _spi->spi_transmit_clk_select){
            (SSPSTATbits.CKE = 0);
        }
        else if(1 == _spi->spi_transmit_clk_select){
            (SSPSTATbits.CKE = 1);
        }
        else{ }
