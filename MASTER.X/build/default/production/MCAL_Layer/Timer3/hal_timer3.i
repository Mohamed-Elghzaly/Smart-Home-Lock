...
# 39 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
static void Timer3_Mode_Select(const timer3_t *_timer){
    if(0 == _timer->timer3_mode){
        ...
        (T3CONbits.TMR3CS = 1);
        if(0 == _timer->timer3_synchronization){
            (T3CONbits.T3SYNC = 0);
        }
        else if(1 == _timer->timer3_synchronization){
            (T3CONbits.T3SYNC = 1);
        }
        else{ }
    }
...
static void Timer3_16Bit_RW_Select(const timer3_t *_timer){
    if(0 == _timer->timer3_16Bit_RW_mode){
        (T3CONbits.RD16 = 0);
    }
    else if(1 == _timer->timer3_16Bit_RW_mode){
        (T3CONbits.RD16 = 1);
    }
    else{ }
}
