...
# 1 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
static __attribute__((inline)) void adc_select_voltage_reference(const adc_cfg_t *_adc);
...
static __attribute__((inline)) void adc_select_voltage_reference(const adc_cfg_t *_adc){
    if(0x01 == _adc->voltage_reference){
        do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1; }while(0);
    }
    else if(0x00 == _adc->voltage_reference){
        do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1= 1; }while(0);
    }
    else{
        do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1= 1; }while(0);
    }
