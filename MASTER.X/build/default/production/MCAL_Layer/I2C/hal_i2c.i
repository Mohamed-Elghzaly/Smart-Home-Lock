...
# 369 "C:/Program Files (x86)/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\pic18_chip_select.h" 3
...
# 370 "C:/Program Files (x86)/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\pic18_chip_select.h" 2 3
...
# 39 "MCAL_Layer/I2C/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
static void (*MSSP_I2C_InterruptHandler)(void) = ((void*)0);
static void (*MSSP_I2C_Recieve_OverFlow_InterruptHandler)(void) = ((void*)0);
static void (*MSSP_I2C_collision_IntrruptHandler)(void) = ((void*)0);


void __attribute__((inline)) GPIO_Config(void);
void Master_Mode_Clock_CFG(const MSSP_I2C_t *_i2c_);
static __attribute__((inline)) void MSSP_I2C_Intrrupt_Config(const MSSP_I2C_t *_i2c_);
...
Std_ReturnType I2C_Initialize(const MSSP_I2C_t *_i2c){
    ...
    if(((void*)0) == _i2c){
        ...
        if(1 == _i2c->i2c_cfg.i2c_Mode){

            Master_Mode_Clock_CFG(_i2c);
        }
        else if(0 == _i2c->i2c_cfg.i2c_Mode){

            if(1 == _i2c->i2c_cfg.general_call){
                (SSPCON2bits.GCEN = 1);
            }
            else if(0 == _i2c->i2c_cfg.general_call){
                (SSPCON2bits.GCEN = 0);
            }
            else{ }
        ...
        if(1 == _i2c->i2c_cfg.slew_rate){
                (SSPSTATbits.SMP = 1);
            }
            else if(0 == _i2c->i2c_cfg.slew_rate){
                (SSPSTATbits.SMP = 0);
            }
            else{ }
...
void Master_Mode_Clock_CFG(const MSSP_I2C_t *_i2c){
    ...
    SSPADD = (uint8)(((8000000 / 4.0) / _i2c->i2c_clock) - 1);
}
