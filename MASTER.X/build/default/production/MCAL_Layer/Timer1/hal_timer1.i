...
# 39 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
static void Timer1_Mode_Select(const timer1_t *_timer){
    if(0 == _timer->timer1_mode){
        ...
        (T1CONbits.TMR1CS = 1);
        if(0 == _timer->timer1_synchronization){
            (T1CONbits.T1SYNC = 0);
        }
        else if(1 == _timer->timer1_synchronization){
            (T1CONbits.T1SYNC = 1);
        }
        else{ }
    }
