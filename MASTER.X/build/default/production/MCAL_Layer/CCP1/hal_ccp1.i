...
# 16 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/CCP1/../GPIO/../device_config.h" 1
# 16 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/CCP1/../GPIO/hal_gpio_cfg.h" 1
# 17 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h" 2
# 39 "MCAL_Layer/CCP1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_conifg.h" 1
# 15 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_conifg.h"
# 1 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_conifg.h" 2
# 57 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_conifg.h"
typedef enum{
...
# 121 "MCAL_Layer/CCP1/hal_ccp1.h"
...
Std_ReturnType CCP_PWM_Initialize(const ccp_t *_obj){
    ...
    if(((void*)0) == _obj){
        ...
        PR2 = (uint8)((8000000 / (_obj->PWM_frequancy * 4.0 * _obj->prescaler_value * _obj->postscaler_value))-1);
...
# 275 "MCAL_Layer/CCP1/hal_ccp1.c"
Std_ReturnType CCP_CaptureMode_Initialize(const ccp_t *_obj){
    Std_ReturnType status = (Std_ReturnType)0X00;
    if(((void*)0) == _obj){
        status = (Std_ReturnType)0X00;
...
Std_ReturnType CCP_IsCaptureOccur(const ccp_t *_obj, uint8 *_capture){
    Std_ReturnType status = (Std_ReturnType)0X00;
    if((((void*)0) == _capture) || (((void*)0) == _obj)){
        status = (Std_ReturnType)0X00;
    }
    else{
        if(CCP1_MODULE == _obj->select_module){
...
# 428 "MCAL_Layer/CCP1/hal_ccp1.c"
static void CCP_Interrupt_CFG(const ccp_t *_obj){
# 468 "MCAL_Layer/CCP1/hal_ccp1.c"
}

static void CCP_Capture_Compare_Time(const ccp_t *_obj){
    if(0 == _obj->capture_timer){
                T3CONbits.T3CCP1 = 0;
                T3CONbits.T3CCP2 = 1;
            }
            else if(1 == _obj->capture_timer){
                T3CONbits.T3CCP1 = 1;
                T3CONbits.T3CCP2 = 0;
            }
            else if(2 == _obj->capture_timer){
                T3CONbits.T3CCP1 = 0;
                T3CONbits.T3CCP2 = 0;
            }else{ }
}
